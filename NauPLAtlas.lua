...
-- // Window \\ --
local window = library.new('w nauhb', 'nauhb')
...
-- // Sections \\ --
local section = tab.new_section('stuff')
local section1 = tab.new_section('more stuff >:D')

-- // Sector \\ --
local sector = section.new_sector('stuff', 'stuff again')
local sector1 = section.new_sector('stuff 2', 'stuff 2 again')
